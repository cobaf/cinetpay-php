 ...
 */
  ...
  * @category cinetpay
  * @package  cinetpay
  * @copyright Copyright (c) 2015-2023 CinetPay Inc. (https://www.cinetpay.com)
  ...
  */
  ...
  class CinetPay
  {
     ...
     */
      ...
      public array|string $channels = 'ALL';
     ...
     */
      ...
      public function generatePaymentLink(?array $param): array 
      {
        ...
        if (!empty($param['invoice_data'])) $this->invoice_data = $param['invoice_data'];
      ...
      public function getPayStatus($id_transaction,$site_id)
      {
        ...
        $this->chk_payment = $StatusPayment;
